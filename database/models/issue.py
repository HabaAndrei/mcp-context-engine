...
Epics, tasks and subtasks share this one table and are told apart by
`issue_type`. Hierarchy lives in the `Dependency` table as a `parent-child`
edge pointing from child to parent, which keeps re-parenting a one-row change
and lets containment and blocking be queried the same way.
"""
